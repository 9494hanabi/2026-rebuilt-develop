...
public class SetZeroCommand extends Command {
    ...
    public void execute() {
        ...
        System.out.printf("[SetZero] pos=(%.2f, %.2f, %.2f) vel=(%.2f, %.2f, %.2f) atSetpoint=%b%n",
                currentXMeter, currentYMeter, currentHeadingRad, translationX, translationY, omega, atSetpoint);
