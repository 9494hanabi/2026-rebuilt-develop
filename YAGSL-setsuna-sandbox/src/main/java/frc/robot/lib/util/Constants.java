...
public final class Constants {
  ...
  public static class FieldConstants {
    ...
    public static final Pose2d kInitialFieldToRobotPose = 
            new Pose2d(0.00, 0.00, Rotation2d.fromDegrees(0.0));    
  }
  ...
  public static class CommandConstants {
    ...
    // Field: X=0..6.05 (fieldlength), Y=0..9.0 (fieldwidth)
    public static final Map<Integer, Pose2d> tagToVertexMap = Map.ofEntries(
        // 右上コーナー (6.05, 9.0) — タグ1,2
        Map.entry(1, new Pose2d(5.55, 8.50, Rotation2d.fromDegrees(45.0))),
        Map.entry(2, new Pose2d(5.55, 8.50, Rotation2d.fromDegrees(45.0))),
        // 左上コーナー (0, 9.0) — タグ3,4
        Map.entry(3, new Pose2d(0.50, 8.50, Rotation2d.fromDegrees(135.0))),
        Map.entry(4, new Pose2d(0.50, 8.50, Rotation2d.fromDegrees(135.0))),
        // 右下コーナー (6.05, 0) — タグ5,6
        Map.entry(5, new Pose2d(5.55, 0.50, Rotation2d.fromDegrees(-45.0))),
        Map.entry(6, new Pose2d(5.55, 0.50, Rotation2d.fromDegrees(-45.0))),
        // 左下コーナー (0, 0) — タグ7,8
        Map.entry(7, new Pose2d(0.50, 0.50, Rotation2d.fromDegrees(-135.0))),
        Map.entry(8, new Pose2d(0.50, 0.50, Rotation2d.fromDegrees(-135.0)))
    );
  }
